...
namespace GlobalNamespace
{
    public static class GlobalMethods
    {
        ...
        public static bool AreAnglesEqual(float angle1, float angle2, float tolerance = 0.01f)
        {
            angle1 = Mathf.Repeat(angle1, 360f);
            angle2 = Mathf.Repeat(angle2, 360f);

            float diff = Mathf.Abs(Mathf.DeltaAngle(angle1, angle2));
