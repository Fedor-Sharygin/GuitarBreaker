    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                //ONLY FOR KEYBOARD/GAMEPAD GAMES ONLY
        ...
        private void CheckDuplicateBindings(InputAction p_Action, int p_BindingIndex, bool p_AllCompositeParts = false)
        {
            ...
            InputBinding CurBinding = p_Action.bindings[p_BindingIndex];
            foreach (RebindActionUI ORebindUI in s_RebindActionUIs)
            {
                if (ORebindUI == this || CurBinding.effectivePath != ORebindUI.m_Action.action.bindings[0].effectivePath)
                {
                    continue;
                }

                ORebindUI.m_Action.action.ApplyBindingOverride(0, "");
                //ORebindUI.m_BindingText.text = "...";
                ORebindUI.m_UpdateBindingUIEvent?.Invoke(ORebindUI, "", "", "");
                break;
            }
        }
        ...
        {
            foreach (RebindActionUI RebindElem in s_RebindActionUIs)
            {
                RebindElem?.UpdateBindingDisplay();
            }
        }
